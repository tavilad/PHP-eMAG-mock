...
class OrderItemController extends AbstractController
{
    ...
    {
        return $this->render('order_item/index.html.twig', ['order_items' => $orderItemRepository->findAll()]);
    }
    ...
    {
        return $this->render('order_item/show.html.twig', ['order_item' => $orderItem]);
    }
    ...
    public function edit(Request $request, OrderItem $orderItem): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('order_item_index', ['id' => $orderItem->getId()]);
        }
